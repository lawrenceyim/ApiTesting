...
public class Footer extends AbstractUIObject {
    @FindBy(xpath = "/footer/div[2]/div[1]/div/div[2]/div/a[1]")
    private ExtendedWebElement supportButton;
    @FindBy(xpath = "/footer/div[2]/div[1]/div/div[2]/div/a[2]")
    private ExtendedWebElement newsButton;
    @FindBy(xpath = "/footer/div[2]/div[1]/div/div[2]/div/a[3]")
    private ExtendedWebElement termsOfUseButton;
    @FindBy(xpath = "/footer/div[2]/div[1]/div/div[2]/div/a[4]")
    private ExtendedWebElement privacyPolicyButton;
    @FindBy(xpath = "/footer/div[2]/div[1]/div/div[2]/div/a[5]")
    private ExtendedWebElement eulaButton;
    @FindBy(xpath = "/footer/div[2]/div[1]/div/div[2]/div/a[6]")
    ...
    public ExtendedWebElement getSupportButton() {
        return supportButton;
    }

    public void setSupportButton(ExtendedWebElement supportButton) {
    ...
    public void setNewsButton(ExtendedWebElement newsButton) {
        this.newsButton = newsButton;
    }

    public ExtendedWebElement getTermsOfUseButton() {
        return termsOfUseButton;
    }

    public void setTermsOfUseButton(ExtendedWebElement termsOfUseButton) {
        this.termsOfUseButton = termsOfUseButton;
    }

    public ExtendedWebElement getPrivacyPolicyButton() {
        return privacyPolicyButton;
    }

    public void setPrivacyPolicyButton(ExtendedWebElement privacyPolicyButton) {
        this.privacyPolicyButton = privacyPolicyButton;
    }

    public ExtendedWebElement getEulaButton() {
        return eulaButton;
    }

    public void setEulaButton(ExtendedWebElement eulaButton) {
        this.eulaButton = eulaButton;
    }

    public ExtendedWebElement getCookiesSettingsButton() {
        return cookiesSettingsButton;
    }

    public void setCookiesSettingsButton(ExtendedWebElement cookiesSettingsButton) {
        this.cookiesSettingsButton = cookiesSettingsButton;
    }
}
